...
\restrict P638sKYE18RHtKmdbrjJ0lhgNswxUI7InKcAl8AowGxXhtqZChGzNqKW2SwMeiu
...
--
-- Name: appointments appointments_client_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT appointments_client_fk FOREIGN KEY (client_id) REFERENCES public.clients(id) ON DELETE RESTRICT;
...
\unrestrict P638sKYE18RHtKmdbrjJ0lhgNswxUI7InKcAl8AowGxXhtqZChGzNqKW2SwMeiu
